...
class HorcruxCreator
{
	public:
		static void horcruxCreator(FILE *iInputFile, int iHorcruxAmount, int iFileSize, const std::string& iHorcruxName, const std::string& iPath)
		{
			size_t buffSize = iFileSize / (iHorcruxAmount - 1);
